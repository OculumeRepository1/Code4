...
camera_index=[0,'rtsp://admin:oculume2025@192.168.1.247/Preview_01_sub']
...
locations=['ghar','100_Street_Entracne']
width=640
height=480
#############################
...
notification_classes = {
                    ...
                    1: 0.45,  # Class 1 threshold
                    2: 0.1,  # Class 2 threshold
                    3: 0.2,  # Class 3 threshold
                    4: 0.45,  # Class 4 threshold
                    5: 0.05,  # Class 5 threshold
                    6: 0.5,  # Class 6 threshold
                                                }
##email Rate Limiting
            ...
            # print(f"Tracking before update {ids} {reg_list} and idx {idx}")
                    ...
                    if ids[4] not in lis and start_times[idx]-end_times[idx]>5:
                        if conf > notification_classes[class_id[0]]:
                            ...
                            dataset=rf"C:\Users\oosma\Oculume_Codes\Dashboard\Code3\{save_dir_dataset}"
                        ...
                        #    print(f"Tracking after update {ids} {reg_list} and idx {idx}")
                            ...
                            print(All_variables[f'last_email_time_{idx}'])
